...
```jsonc
{
    ...
    "copyFormatting": "none",
    "copyOnSelect": false,
    "defaultProfile": "{00000000-0000-0000-ba54-000000000132}",
    "profiles": 
    {
        "defaults": {},
        "list": 
        [
            {
                ...
                "commandline": "cmd.exe /k C:/users/christopherb/cmder/vendor/init.bat",
                "cursorColor": "#FFFFFF",
                "cursorShape": "bar",
                "font": 
                {
                ...
                "hidden": false,
                "historySize": 9001,
                "icon": " C:/users/christopherb/cmder/icons/cmder.ico",
                "name": "Cmder",
                "padding": "10, 10, 10, 10",
                "snapOnInput": true,
